...
export const WeddingInvitationPage = () => {
  ...
  const guestCounrt = useWeddingBoundStore(state => state.guestCount);
  const setGuestCounrt = useWeddingBoundStore(state => state.setGuestCount);
          ...
          <form>
            ...
            <div className="mb-5">
              ...
              <input
                ...
                placeholder="5"
                value={guestCounrt}
                onChange={e => setGuestCounrt(+e.target.value)}
